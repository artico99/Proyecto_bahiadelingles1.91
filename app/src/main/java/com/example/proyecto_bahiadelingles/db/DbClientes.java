...
public class DbClientes extends DbHelper{
    ...
    public long insertarCliente(String nombre, String apellido, String rut, String telefono, String correo, String numeroLoft, String comentario)
    {
        long id = 0;
        try
        {
    ...
    public ArrayList<Cliente> mostrarCliente()
    {
        ...
        if(cursorCliente.moveToFirst())
        {
            do{
                ...
                cliente.setCorreo(cursorCliente.getString(5));
                cliente.setNumeroLoft(cursorCliente.getString(6));
                cliente.setComentario(cursorCliente.getString(7));
    ...
    public boolean editarCliente(int id, String nombre, String apellido, String rut, String telefono, String correo, String numeroLoft, String comentario)
    {
